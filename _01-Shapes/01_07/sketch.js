...
// Global var
var sizeCube, thresholdW, thresholdH, cubeArray = [], x, y, modCounter = 0, transformCubeArray = [], modCounterTransform = 0, speed, resize, yOffset, xOffset;
...
class Cube {
  ...
  getNewPosVertical() {
    ...
    */
    ...
    console.log(this.moveVerticalVec.mag()*4);
  ...
  getNewPosDiagonalRight() {
    ...
    this.x += this.moveDiagonalVecRight.x*2;
    this.y += this.moveDiagonalVecRight.y*2;
  ...
  update() {
    if (this.diagonalCounter <= this.diagonalLength && this.flagDiagonal) {
      ...
      this.getNewPosDiagonalRight();
      this.diagonalCounter+=2;

      if (this.diagonalCounter >= this.diagonalLength) {
        this.flagDiagonal = false;
        this.diagonalCounter = 0;
        this.colorLeft = color(random(127, 255), random(127, 234), random(233, 255));
        this.colorRight = color(random(127, 255), random(127, 234), random(233, 255));
        this.colorTop = color(random(127, 255), random(127, 234), random(233, 255));

      }
    } else {
      if (this.verticalCounter <= this.verticalLength) {
        this.getNewPosVertical();
        this.verticalCounter+=4;
