...
// Global var
var sizeCube, thresholdW, thresholdH, cubeArray = [], x, y, modCounter = 0, transformCubeArray = [], modCounterTransform = 0, speed, resize;
...
class Cube {
  ...
  getNewPosVertical() {
    ...
    */
    this.y += this.moveVerticalVec.mag();
  ...
  getNewPosDiagonalLeft() {
    ...
    this.x += this.moveDiagonalVecLeft.x;
    this.y += this.moveDiagonalVecLeft.y;


  }
  getNewPosDiagonalRight() {
    this.moveDiagonalVecRight.normalize();
    this.x += this.moveDiagonalVecRight.x;
    this.y += this.moveDiagonalVecRight.y;
